...
//       {slide.buttonName && (
//         <div className="absolute left-1/2 top-[50%] transform -translate-x-1/2 z-20">
//           <Link href={slide.buttonRoute || "#"}>
    ...
    >
      ...
      {/* {slide.buttonName && (
        <div className="absolute inset-0 z-20 flex items-center justify-center">
          <Link href={slide.buttonRoute || "#"}>
            <button className="uppercase bg-black/50 text-white border border-white shadow-md px-4 py-2 sm:px-6 sm:py-3 md:px-8 md:py-4 lg:px-10 lg:py-5 rounded-lg hover:bg-gray-800 hover:text-white transition text-xs sm:text-sm md:text-base lg:text-lg">
              {slide.buttonName}
            </button>
          </Link>
        </div>
