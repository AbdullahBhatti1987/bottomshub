...
// //             onClick={() => {
// //               if (!item.hasDropdown) {
// //                 router.push(item.href); // now router is defined
...
//                       className="block w-full text-left px-4 py-2 hover:bg-gray-100 transition text-sm"
//                       onClick={() => {
//                         // You can route dropdown items if needed
//                         // Example: router.push(`/categories/${cat.toLowerCase()}`);
//                       }}
//                     >
//                       {cat}
//                     </button>
...
//               } else {
//                 router.push(item.href); // Mobile navigation works now
...
//         {/* Optional: Mobile Dropdown for Categories */}
//         {dropdownOpen && (
//           <div className="pl-4">
//             {["Men", "Women", "Kids"].map((cat) => (
//               <button
...
export default function Header({ className }) {
  ...
  return (
    ...
    >
      <div className="container w-full md:w-[90%] lg:w-[85%] mx-auto px-4 flex items-center justify-between py-4">
        {/* Logo */}
        <div className="font-bold font-sans text-2xl sm:text-3xl md:text-3xl lg:text-4xl" style={{ color: colors.primary }}>
          BottomsHub
        </div>
          ...
          {menuItems.map((item) =>
            item.hasDropdown ? (
              <div key={item.label} className="relative group" ref={dropdownRef}>
                ...
                >
                  {["Men", "Women", "Kids"].map((cat) => (
                    <button key={`${item.label}-${cat}`} className="block w-full text-left px-4 py-2 hover:bg-gray-100 transition text-sm">
                      {cat}
                    </button>
                  ))}
                </div>
