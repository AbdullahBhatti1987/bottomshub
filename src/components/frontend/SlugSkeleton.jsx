...
//           <div className="h-8 bg-gray-200 rounded w-3/4 mb-4" /> {/* Product name */}
//           <div className="h-4 bg-gray-200 rounded w-full mb-4" /> {/* Short description */}
...
export default function SlugSkeleton() {
  return (
    <div className="py-12 container mx-auto px-4 lg:max-w-7xl">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 animate-pulse">
        {/* Left: Images */}
        <div className="grid grid-cols-[60px_1fr] gap-3 md:gap-4">
          {/* Thumbnails Skeleton */}
          <div className="flex flex-col gap-3 overflow-y-auto max-h-[420px]">
            {[...Array(4)].map((_, idx) => (
              <div
        ...
        <div className="flex flex-col gap-4 md:gap-6">
          ...
          <div className="flex flex-wrap gap-2 mt-2">
            {[...Array(4)].map((_, idx) => (
              <div
                key={idx}
                className="h-12 w-[22%] sm:w-[20%] rounded-lg bg-gray-200"
              />
            ))}
          </div>
          ...
          <div className="flex items-center gap-2 sm:gap-4 mt-3">
            <div className="w-12 h-12 rounded-lg bg-gray-200" /> {/* Minus */}
            <div className="w-24 h-12 rounded-lg bg-gray-200" /> {/* Quantity */}
            <div className="w-12 h-12 rounded-lg bg-gray-200" /> {/* Plus */}
          </div>
          ...
          <div className="flex flex-col gap-4 mt-4 w-full">
            ...
            <div className="h-12 rounded-lg bg-gray-200 w-full mt-2" /> {/* Buy Now */}
          </div>
        </div>
      </div>
    </div>
